...
<template>
  <div class="flex flex-col items-center">
    ...
    <div v-if="account" class="outsidebox">
      <P class="tit1"><span class="hide">～</span>～。里吉拿付款。～<span class="hide">～</span></P><br>
      ...
      <button class="bg-slate-500 rounded p-4 mt-2 b-color" @click="itemcost(getAmount)">
        金額確認
      </button>
      <p>(輸入單位: TWD)</p><br>
